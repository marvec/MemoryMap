...
#include <jni.h>
/* Header for class io_silverspoon_mmap_jni_NativeMmap */

#ifndef _Included_io_silverspoon_mmap_jni_NativeMmap
#define _Included_io_silverspoon_mmap_jni_NativeMmap
#ifdef __cplusplus
extern "C" {
#endif
