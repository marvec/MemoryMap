 ...
 * Signature: (J)V
 */
JNIEXPORT jint JNICALL Java_io_silverspoon_mmap_jni_NativeMmap_deleteMap
 ...
 * Signature: (LI)V
 */
JNIEXPORT void JNICALL Java_io_silverspoon_mmap_jni_NativeMmap_setIntValueAt
 ...
 * Signature: (LI)V
 */
JNIEXPORT void JNICALL Java_io_silverspoon_mmap_jni_NativeMmap_setShortValueAt
 ...
 * Signature: (LI)V
 */
JNIEXPORT void JNICALL Java_io_silverspoon_mmap_jni_NativeMmap_setLongValueAt
 ...
 * Signature: (LI)V
 */
JNIEXPORT void JNICALL Java_io_silverspoon_mmap_jni_NativeMmap_setByteValueAt
 ...
 * Signature: (L)I
 */
JNIEXPORT jint JNICALL Java_io_silverspoon_mmap_jni_NativeMmap_getIntValueAt
 ...
 * Signature: (L)I
 */
JNIEXPORT jbyte JNICALL Java_io_silverspoon_mmap_jni_NativeMmap_getByteValueAt
  (JNIEnv * env, jobject clazz, jlong address) {
	char * ptr = (char *)(intptr_t)address;
	return (jbyte)(*ptr);
}
 ...
 * Signature: (L)I
 */
JNIEXPORT jshort JNICALL Java_io_silverspoon_mmap_jni_NativeMmap_getShortValueAt
  (JNIEnv * env, jobject clazz, jlong address) {
	short * ptr = (short *)(intptr_t)address;
	return (jshort)(*ptr);
}
 ...
 * Signature: (L)I
 */
JNIEXPORT jlong JNICALL Java_io_silverspoon_mmap_jni_NativeMmap_getLongValueAt
  (JNIEnv * env, jobject clazz, jlong address) {
	long * ptr = (long *)(intptr_t)address;
	return (jlong)(*ptr);
}
