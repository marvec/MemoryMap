...
#include <fcntl.h>
#include <unistd.h>
#include "io_silverspoon_mmap_jni_NativeTools.h"


/*
 * Class:     io_silverspoon_mmap_jni_NativeTools
 * Method:    getJavaDescriptor
 * Signature: (I)[Ljava/io/FileDescriptor
 */
JNIEXPORT jobject JNICALL Java_io_silverspoon_mmap_jni_NativeTools_getJavaDescriptor
 ...
 */
JNIEXPORT jint JNICALL Java_io_silverspoon_mmap_jni_NativeTools_open
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_io_silverspoon_mmap_jni_NativeTools_close
